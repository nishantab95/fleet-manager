...
echo Stopping Fleet Manager-owned API and Web processes...
"%UV_EXE%" run --project "%REPO_ROOT%\services\api" "%REPO_ROOT%\launch.py" --stop
set "FLEET_EXIT_CODE=%ERRORLEVEL%"
popd

if not "%FLEET_EXIT_CODE%"=="0" pause
