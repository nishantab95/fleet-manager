...
export function SupervisorShell(props: SupervisorShellProps) {
  ...
  return <main className="admin-shell">
    ...
    <div className="admin-layout single-column"><section className="content">
      ...
      <div className="metric-grid supervisor-qa-summary"><Metric label="Pending Trips" value={pendingTrips} /><Metric label="Pending KM" value={pendingKm} /><Metric label="Pending Diesel" value={pendingDiesel} /><Metric label="Emergencies" value={emergencies} /></div>
