...
export type SupervisorEvent = { event_id: string; event_type: "TRIP_COMPLETE" | "KM_READING" | "DIESEL" | "EMERGENCY"; assignment_id: string; driver_name: string; driver_phone: string | null; tipper_registration_number: string; site_id: string; site_name: string; device_created_at: string; server_received_at: string; verification_status: VerificationStatus; reading_type: "START_READING" | "END_READING" | null; reading_value: string | null; litres: string | null; emergency_category: string | null; emergency_status: string | null; emergency_description: string | null; evidence_id: string | null; evidence_available: boolean; verification_history: SupervisorHistory[] };
...
export type ReportEvent = { event_id: string; event_type: "TRIP_COMPLETE" | "KM_READING" | "DIESEL" | "EMERGENCY"; assignment_id: string; tipper_id: string; tipper_registration_number: string; site_id: string; site_name: string; driver_name: string; driver_phone: string | null; supervisor_name: string; device_created_at: string; server_received_at: string; verification_status: VerificationStatus; reading_type: string | null; reading_value: number | null; litres: number | null; emergency_category: string | null; emergency_status: string | null; emergency_description: string | null; evidence_available: boolean; verification_history: ReportHistory[] };
...
export type DriverDutyReport = { operational_date: string; session_id: string; assignment_id: string; driver_name: string; tipper_registration_number: string; site_name: string; duty_start: string; start_km: number; regular_duty_minutes: number; regular_duty_ends_at: string; actual_duty_end: string | null; end_km: number | null; actual_duty_span_seconds: number | null; overtime_minutes: number; status: "ACTIVE" | "CLOSED" };
